...
export const mipgTasks = [
	...
	{
		title: 'Revisar plan de acción',
		owner: 'Gestión con Valores',
		state: 'En curso',
		due: 'En 5 días'
	},
	{
		title: 'Cargar evidencia',
		owner: 'Direccionamiento Estratégico',
		state: 'Pendiente',
		due: 'En 8 días'
	},
...
export const actionPlans = [
	{
		title: 'Fortalecer inducción institucional',
		process: 'Talento Humano',
		owner: 'Responsable de dimensión',
		status: 'En curso',
		progress: 70,
		due: '15/10/2026'
	},
	{
		title: 'Actualizar política de comunicación',
		process: 'Información y Comunicación',
		owner: 'Líder de proceso',
		status: 'Pendiente',
		progress: 20,
		due: '30/10/2026'
	},
	{
		title: 'Implementar controles de seguimiento',
...
export const mipgRiskSummary = [
	{ label: 'Riesgos registrados', value: '18', detail: 'Inventario institucional' },
	{ label: 'Riesgos altos', value: '4', detail: 'Requieren atención prioritaria' },
	{ label: 'Controles en seguimiento', value: '12', detail: 'Con responsable asignado' }
];
