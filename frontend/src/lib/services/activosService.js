...
const exampleAssets = [
	...
	{
		identifier: 'AI-EJ-003',
		name: 'Expedientes contractuales',
		type: 'Documento',
...
export function getAssetsForSelection() {
	...
	for (const asset of [...exampleAssets, ...getStoredAssets()]) {
		if (!asset?.identifier || assetsByIdentifier.has(asset.identifier)) continue;
		assetsByIdentifier.set(asset.identifier, asset);
	}
